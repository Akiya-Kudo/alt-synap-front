...
export const Validation_post_title = {
    ...
    maxLength: { value: 100, message: '100文字以下で入力してください | less than 100 words' },
    minLength: { value: 2, message: "2文字以上で入力してください | more than 2 words" },
}
...
export const Validation_folder_name = {
    required: "タイトルは必須です | Title is required",
    maxLength: { value: 100, message: '100文字以下で入力してください | Please make title less than 50 words' },
    minLength: { value: 2, message: "2文字以上で入力してください | Please make title more than 2 words" },
}

export class CommentMaxValidationError extends Error {
    type: string;
    constructor (message: string, type: string) {
        super(message);
        this.name = "CommentMaxLengthError";
        this.type = type
    }
}